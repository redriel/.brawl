...
if (attack_fighter.stamina > defense_fighter.stamina):
    ...
    print(f"{defense_fighter.name} lose the match with {defense_fighter.stamina} hp left")
else:
    print(f"\n{defense_fighter.name} won the match with {defense_fighter.stamina} hp left")
    print(f"{attack_fighter.name} lose the match with {attack_fighter.stamina} hp left")
